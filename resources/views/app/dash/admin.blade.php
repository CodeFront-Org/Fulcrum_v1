...
@section('content')
    <div class="container-fluid py-4">
        ...
        <div class="row align-items-center mb-4">
            <div class="col">
                <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Administrator Console</h1>
                <p class="text-muted mb-0">At-a-glance overview of system performance and active requests.</p>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card dash-card h-100 p-3">
                    ...
                    <div class="mt-2 small text-muted">Across all departments</div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card dash-card h-100 p-3">
                    ...
                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Registered Companies</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card dash-card h-100 p-3">
                    <div class="card-icon icon-info"><i class="fas fa-award"></i></div>
                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Successful Approvals</div>
                    <div class="h3 mb-0 font-weight-bold text-gray-800">{{ $tot_approvals }}</div>
                    <div class="mt-2 small text-muted">Fully disbursed applications</div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card dash-card h-100 p-3">
                    ...
                    <div class="mt-2 small text-muted">Awaiting applicant correction</div>
                </div>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 16px;">
            <div class="card-header bg-white py-3 border-0 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-gray-800">Pending Action Queue</h6>
                <a href="{{ route('loan-requests') }}" class="btn btn-sm btn-light text-primary font-weight-bold">View Full
                    Registry</a>
            </div>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-5">
                                    ...
                                    <p class="text-muted">All caught up! No pending requests at the moment.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
