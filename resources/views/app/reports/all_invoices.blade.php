...
<form method="GET" action="#">
    ...
    <datalist id="regnoo">
        ...
        <div class="mb-3 col-md-3">
            ...
            <select name="month" class="form-control form-select" id="">
        ...
        <div class="mb-3 col-md-3">
            ...
            <select name="year" class="form-control form-select" id="">
...
<button id="excelbtn" style="width:90px" type="button" class="btn btn-success"><i class="fa fa-file-excel bg-success"></i> excel </button>
                ...
                <div class="card-header py-3 text-center">
                    <h6 class="m-0 font-weight-bold text-primary">
                           Loan Requests for period {{$for_date}}
                        </h6>
                      </div>
                      <div class="card-body">
                        <div class="table-responsive">
                            ...
                            {{-- <tr>
                                <td colspan="3" style="text-align:right;font-weight:bold">Total Loan Requested</td>
                                <td colspan="1" style="text-align: left">{{number_format($tot_loan)}}</td>
                            </tr>
                            <tr>
                                <td colspan="3" style="text-align:right;font-weight:bold">Total Expected Repayment</td>
                                <td colspan="1" style="text-align: left">{{number_format($tot_expected_payments)}}</td>
                            </tr> --}}
                            <tr>
                                <td colspan="3" style="text-align:right;font-weight:bold">Expected Monthly Installments</td>
                                <td colspan="1" style="text-align: left">{{number_format($tot_monthly_installments)}}</td>
                            </tr>
                            <tr>
                                <td colspan="3" style="text-align:right;font-weight:bold">Total Amount Paid</td>
                                <td colspan="1" style="text-align: left">{{number_format($tot_amt_paid)}}</td>
                            </tr>
                            {{-- <tr>
                                <td colspan="3" style="text-align:right;font-weight:bold">Net<span class="text-success"> Profit</span> / <span class="text-danger">Loss</span></td>
                                @if ($net1
                            ...
                            <tr style="font-weight:bolder;">
                                <td colspan="3" style="text-align:right;font-weight:bold">Report summary</td>
                                @if ($net1
